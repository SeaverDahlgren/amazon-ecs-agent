			...
			"Containers": &graphql.Field{
				...
				Resolve: func(p graphql.ResolveParams) (interface{}, error) {
					if task, ok := p.Source.(*apitask.Task); ok {
						...
						if !ok {
							return "", errors.Errorf("GraphQL task response: unable to get container name mapping for task %v",
								task.Arn)
						}
	...
	fields := graphql.Fields{
		"Container": &graphql.Field{
			...
			Resolve: func(p graphql.ResolveParams) (interface{}, error) {
				...
				if !ok {
					return nil, errors.Errorf("GraphQL Schema Error: Could not cast to container")
				}
		...
		"Task": &graphql.Field{
			...
			Resolve: func(p graphql.ResolveParams) (interface{}, error) {
				...
				if !ok {
					return nil, errors.New("GraphQL Schema Error: Could not cast to task")
				}
