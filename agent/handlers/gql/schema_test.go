...
var (
	...
	expectedFailedContainerTaskResponse = gqlResponse{
		Errors: "GraphQL task response: unable to get container name mapping for task " + taskARN,
	}
	expectedFailedContainerCTXResponse = gqlResponse{
		Errors: "GraphQL Schema Error: Could not cast to container",
	}
	expectedFailedTaskCTXResponse = gqlResponse{
		Errors: "GraphQL Schema Error: Could not cast to task",
	}
...
func TestCreateSchema(t *testing.T) {
	...
	if containerNameToDockerContainer == nil {
		return
	}
